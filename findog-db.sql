...
CREATE TABLE `Animal` (
    ...
    `desertionNum` varchar(15)  NOT NULL ,
    `filename` varchar(100)  NOT NULL ,
    `happenDt` varchar(8)  NOT NULL ,
    `happenPlace` varchar(100)  NOT NULL ,
    `kindCd` varchar(50)  NOT NULL ,
    `colorCd` varchar(30)  NOT NULL ,
    `age` varchar(30)  NOT NULL ,
    `weight` varchar(30)  NOT NULL ,
    `noticeNum` varchar(30)  NOT NULL ,
    `noticeSdt` varchar(8)  NOT NULL ,
    `noticeEdt` varchar(8)  NOT NULL ,
